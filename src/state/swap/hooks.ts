...
export function useDerivedSwapInfo(router: string): {
  ...
  if (!to || !formattedTo) {
    ...
    const BAD_RECIPIENT_ADDRESSES = router === 'sushiswap' ? SUSHISWAP_BAD_RECIPIENT_ADDRESSES : UNISWAP_BAD_RECIPIENT_ADDRESSES
    if (
